...
5. Manter IDs oficiais de teste no Debug. O Release usa IDs de produção autorizados; não alterar essa separação nem trocar unidades sem autorização explícita do responsável pelo projeto.
