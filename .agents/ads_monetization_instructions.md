...
5. Manter IDs oficiais de teste no Debug. Por decisão do responsável (2026-09-23), o Release também usa temporariamente IDs de teste; não reintroduzir IDs de produção nem trocar unidades sem autorização explícita do responsável pelo projeto.
