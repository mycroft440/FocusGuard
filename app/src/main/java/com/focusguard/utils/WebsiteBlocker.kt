...
/**
 * Utilidades de texto para regras de domínio/palavra gravadas por versões antigas
 * (exibição e comparação de dados legados). O bloqueio de sites em si fica em
 * com.focusguard.sitesblocker.
 */
